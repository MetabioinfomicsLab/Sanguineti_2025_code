...
class Community(cobra.Model):
    ...
    def cooperative_tradeoff(
        ...
        min_growth=0.0,
        fraction=1.0,
        beta=0.0, # Modified cooperative tradeoff: beta parameter added as argument
        fluxes=False,
        pfba=False,
        atol=None,
        rtol=None,
        ...
        return cooperative_tradeoff(
            self, min_growth, fraction, fluxes, pfba, atol, rtol, beta=beta # Modified cooperative tradeoff: beta parameter given as argument to cooperative_tradeoff function
        )
