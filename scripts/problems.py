...
def regularize_l2_norm(community, min_growth, beta=0.0): # Modified cooperative tradeoff: beta parameter added as argument
    ...
    for sp in community.taxa:
        ...
        if not isinstance(ex, int):
            l2 += (community.scale * (((community.taxonomy['abundance'][sp]**beta)*ex)**2)).expand() # Modified cooperative tradeoff: species relative abundance and beta parameter added as arguments of the square function 
...
def cooperative_tradeoff(community, min_growth, fraction, fluxes, pfba, atol, rtol, beta=0.0): # Modified cooperative tradeoff: beta parameter added as argument
    ...
    with community as com:
        ...
        regularize_l2_norm(com, 0.0, beta=beta) # Modified cooperative tradeoff: beta parameter given as argument to regularize_l2_norm function
        results = []
        for fr in fraction:
